...
export type { KirbankToken } from "./contracts/Kirbank.sol/KirbankToken";
export { KirbankToken__factory } from "./factories/contracts/Kirbank.sol/KirbankToken__factory";
